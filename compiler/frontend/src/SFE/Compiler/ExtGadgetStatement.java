...
public class ExtGadgetStatement extends StatementWithOutputLine implements OutputWriter {
    ...
    public ExtGadgetStatement(List<List<LvalExpression>> inVars, List<LvalExpression> outVars, int compNum) {
        this.inVars = inVars;
...
// ** iterator infrastructure for input and output variables **
    ...
    private IterLLCall toCircuitIter = new IterLLCall() {
        void call (List<LvalExpression> thisL, int i) {
            thisL.get(i).toCircuit(null, ExtGadgetStatement.this.circuit);
            ExtGadgetStatement.this.circuit.print(" ");
        }
    };
